...
This export embeds Framer's actual runtime (`react`, `motion`, `framer`, 282 chunks total, 79825 KB) so the page renders byte-for-byte identical to your live Framer site.

> Generated for **reddent1.framer.website** on 2026-07-26.
